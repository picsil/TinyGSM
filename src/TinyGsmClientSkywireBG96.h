...
#ifndef SRC_TINYGSMCLIENTSKYWIREBG96_H_
...
class TinyGsmSkywireBG96 : public TinyGsmModem<TinyGsmSkywireBG96>,
                    public TinyGsmGPRS<TinyGsmSkywireBG96>,
                    public TinyGsmTCP<TinyGsmSkywireBG96, TINY_GSM_MUX_COUNT>,
                    public TinyGsmCalling<TinyGsmSkywireBG96>,
                    public TinyGsmSMS<TinyGsmSkywireBG96>,
                    public TinyGsmTime<TinyGsmSkywireBG96>,
                    public TinyGsmGPS<TinyGsmSkywireBG96>,
                    public TinyGsmBattery<TinyGsmSkywireBG96>,
                    public TinyGsmTemperature<TinyGsmSkywireBG96> {
  friend class TinyGsmModem<TinyGsmSkywireBG96>;
  friend class TinyGsmGPRS<TinyGsmSkywireBG96>;
  friend class TinyGsmTCP<TinyGsmSkywireBG96, TINY_GSM_MUX_COUNT>;
  friend class TinyGsmCalling<TinyGsmSkywireBG96>;
  friend class TinyGsmSMS<TinyGsmSkywireBG96>;
  friend class TinyGsmTime<TinyGsmSkywireBG96>;
  friend class TinyGsmGPS<TinyGsmSkywireBG96>;
  friend class TinyGsmBattery<TinyGsmSkywireBG96>;
  friend class TinyGsmTemperature<TinyGsmSkywireBG96>;

  /*
   * Inner Client
   */
 public:
  class GsmClientSkywireBG96 : public GsmClient {
    friend class TinyGsmSkywireBG96;

   public:
    GsmClientSkywireBG96() {}

    explicit GsmClientSkywireBG96(TinyGsmSkywireBG96& modem, uint8_t mux = 0) {
      init(&modem, mux);
    }

    bool init(TinyGsmSkywireBG96* modem, uint8_t mux = 0) {
      this->at       = modem;
      sock_available = 0;
      prev_check     = 0;
  ...
  public:
  class GsmClientSecureSkywireBG96 : public GsmClientSkywireBG96
  {
  public:
    GsmClientSecureSkywireBG96() {}

    explicit GsmClientSecureSkywireBG96(TinyGsmSkywireBG96& modem, uint8_t mux = 0)
     : GsmClientSkywireBG96(modem, mux) {}
   ...
   */
 public:
  explicit TinyGsmSkywireBG96(Stream& stream) : stream(stream) {
 ...
 protected:
  bool initImpl(const char* pin = NULL) {
    ...
    DBG(GF("### TinyGSM Compiled Module:  TinyGsmClientSkywireBG96"));
 ...
 protected:
  bool modemConnect(const char* host, uint16_t port, uint8_t mux,
    ...
    if (ssl) {
      // <PDPContextID>(1-16), <SSLContextID>(0-5),
      // <connectID>(0-11), "<IP_address>/<domain_name>",
      // <remote_port>, <access_mode>(0-2; 0=buffer)
      sendAT(GF("+QSSLOPEN=1,0,"), mux, GF(",\""), host, GF("\","), 
            port, GF(",0"));
    }
    else {
  ...
  bool modemGetConnected(uint8_t mux) {
    ...
    sendAT(GF("+QSSLSTATE="), mux);
      // +QSSLSTATE: <clientID>, "SSLClient", <IP_address>,
      // <remote_port>, <local_port>, <socket_state>, <PDP_context>,
      // <serverID>, <access_mode>, <at_port>, <sslctxID>
 ...
 protected:
  GsmClientSkywireBG96* sockets[TINY_GSM_MUX_COUNT];
